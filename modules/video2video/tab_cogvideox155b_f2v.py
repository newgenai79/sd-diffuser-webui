...
def get_pipeline(memory_optimization, vaeslicing, vaetiling):
    ...
    if (modules.util.config.global_pipe is not None and 
        type(modules.util.config.global_pipe).__name__ == "CogVideoXFunControlPipeline" and
    ...
    modules.util.config.global_pipe = CogVideoXFunControlPipeline.from_pretrained(
