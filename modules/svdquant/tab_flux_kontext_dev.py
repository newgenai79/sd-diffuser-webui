...
def generate_images(
    ...
    reference_image, use_qencoder # , width, height, input_image2
):
...
def create_flux_kontext_tab():
    ...
    # gr.HTML("<style>.small-button { max-width: 2.2em; min-width: 2.2em !important; height: 2.4em; line-height: 1em; border-radius: 0.5em; } .center-button-container { display: flex !important; align-items: center !important; justify-content: center !important; height: 512px !important; }</style>", visible=False)
    ...
    with gr.Accordion("Select model / Optimization", open=True):
        with gr.Row():
            ...
            with gr.Column(scale=1):
                flux_use_qencoder = gr.Checkbox(label="Use qencoder (quantized text_encoder_2)", value=False, interactive=True)        
    with gr.Row():
        with gr.Column():
    ...
    def save_current_state(memory_optimization, guidance_scale, inference_steps, 
            performance_optimization): # , width, height
        ...
        return memory_optimization, guidance_scale, inference_steps, performance_optimization # , width, height
    ...
    generate_button.click(
        ...
        inputs=[
            ...
            flux_preview_inpaint_reference_image, flux_use_qencoder # , flux_width, flux_height, flux_input_image2
        ],
