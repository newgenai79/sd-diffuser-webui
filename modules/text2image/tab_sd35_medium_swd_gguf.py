...
gguf_list = [
    "sd3.5_medium-F16.gguf - 4.94 GB",
    "sd3.5_medium-Q3_K_M.gguf - 1.49 GB", 
    "sd3.5_medium-Q3_K_S.gguf - 1.45 GB", 
    "sd3.5_medium-Q4_0.gguf - 1.74 GB", 
    "sd3.5_medium-Q4_1.gguf - 1.88 GB", 
    "sd3.5_medium-Q4_K_M.gguf - 1.79 GB", 
    "sd3.5_medium-Q4_K_S.gguf - 1.74 GB", 
    "sd3.5_medium-Q5_0.gguf - 2.02 GB", 
    "sd3.5_medium-Q5_1.gguf - 2.16 GB", 
    "sd3.5_medium-Q5_K_M.gguf - 2.07 GB", 
    "sd3.5_medium-Q5_K_S.gguf - 2.02 GB", 
    "sd3.5_medium-Q6_K.gguf - 2.32 GB", 
    "sd3.5_medium-Q8_0.gguf - 2.86 GB"
]
...
def get_pipeline(memory_optimization, gguf_file, vaeslicing, vaetiling, inference_type, selected_lora):
    ...
    transformer_path = f"https://huggingface.co/city96/stable-diffusion-3.5-medium-gguf/blob/main/{gguf_file}"
...
def generate_images(
    ...
    try:
        ...
        pipe = get_pipeline(memory_optimization, gguf_file, vaeslicing, vaetiling, "sd3.5_medium_swd_gguf", selected_model)
        generator = torch.Generator(device="cpu").manual_seed(seed)
        progress_bar = gr.Progress(track_tqdm=True)
        sigmas = models[selected_model]["sigmas"]
        base_filename = "sd35_medium_swd_gguf.png"
        ...
        for img_idx in range(no_of_images):
            ...
            gallery_items.append((output_path, f"SD3.5-Medium/{selected_model}"))
...
def create_sd35_medium_swd_gguf_tab():
    ...
    with gr.Row():
        with gr.Column():
            swd_gguf_dropdown = gr.Dropdown(
                choices=gguf_list,
                value=initial_state.get("gguf", "sd3.5_medium-Q8_0.gguf - 2.86 GB"),
                label="Select GGUF"
            )
        with gr.Column():
