...
def create_lumina2_BnB_tab():
    ...
    def save_current_state(quantization, memory_optimization, vaeslicing, vaetiling, resolution, guidance_scale, inference_steps):
        state_dict = {
    ...
    generate_button.click(
        ...
        inputs=[
            ...
            lumina2_vaeslicing, lumina2_vaetiling, lumina2_quantization
        ],
