...
def create_lumina2_gguf_tab():
    ...
    with gr.Row():
        ...
        with gr.Column():
            with gr.Row():
                lumina2_gguf_width_input = gr.Number(
                    label="Width", 
                    value=initial_state.get("width", 1024),
                    interactive=True
                )
                lumina2_gguf_height_input = gr.Number(
                    label="Height", 
    ...
    def save_current_state(gguf, memory_optimization, vaeslicing, vaetiling, width, height, guidance_scale, inference_steps):
        state_dict = {
            "gguf": gguf,
    ...
    save_state_button.click(
        ...
        inputs=[
            ...
            lumina2_gguf_width_input, 
            lumina2_gguf_height_input, 
    ...
    generate_button.click(
        fn=generate_images,
        inputs=[
            seed_input, lumina2_gguf_prompt_input, lumina2_gguf_negative_prompt_input, lumina2_gguf_width_input, 
            lumina2_gguf_height_input, lumina2_gguf_guidance_scale_slider, lumina2_gguf_num_inference_steps_input, 
            lumina2_gguf_memory_optimization, lumina2_gguf_vaeslicing, lumina2_gguf_vaetiling, lumina2_gguf_dropdown
        ],
