...
from modules.svdquant.tab_flux_kontext_dev import create_flux_kontext_tab
        ...
        with gr.Tab("Nunchaku"):
            with gr.Tabs():
                with gr.Tab("Flux.1-D / Schnell / Shuttle-Jaguar"):
                    create_flux_dev_tab()
                with gr.Tab("Flux.1-D - Canny / Depth / Fill"):
                    create_flux_canny_tab()
                with gr.Tab("Flux.1-D - Redux"):
                    create_flux_redux_tab()
                with gr.Tab("Flux.1-D - Pulid"):
                    create_flux_pulid_tab()
                with gr.Tab("Flux.1-D - ControlNet Union Pro"):
                    create_flux_controlnet_union_pro_tab()
                with gr.Tab("Flux.1-D - Kontext"):
